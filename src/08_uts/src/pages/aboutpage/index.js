import AboutImg1 from '../../assets/img/tm-img-310x180-1.jpg';
import AboutImg2 from '../../assets/img/tm-img-310x180-2.jpg';
import AboutImg3 from '../../assets/img/tm-img-310x180-3.jpg';
                      ...
                      <div class="row tm-margin-t-mid">
                          <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                              ...
                              <div class="tm-content-box">
                                  <img src={AboutImg1} alt="Image" class="tm-margin-b-30 img-fluid"/>
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                              ...
                              <div class="tm-content-box">
                                  <img src={AboutImg2} alt="Image" class="tm-margin-b-30 img-fluid"/>
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                              ...
                              <div class="tm-content-box">
                                  <img src={AboutImg3} alt="Image" class="tm-margin-b-30 img-fluid"/>
