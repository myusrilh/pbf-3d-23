import ContactImg1 from '../../assets/img/tm-img-310x180-1.jpg';
import ContactImg2 from '../../assets/img/tm-img-310x180-2.jpg';

import ContactImg3 from '../../assets/img/tm-img-240x120-1.jpg';
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="tm-content-box tm-content-box-contact">
                                        <img src={ContactImg1} alt="Image" class="tm-margin-b-20 img-fluid"/>
                                    ...
                                    <div class="tm-content-box tm-margin-t-mid tm-content-box-contact">
                                        <img src={ContactImg2} alt="Image" class="tm-margin-b-20 img-fluid"/>
                                    ...
                                    <div class="tm-contact-related-posts-container">
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src={ContactImg3} alt="Generic placeholder image"/>
                                            </a>
                                          </div>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src={ContactImg4} alt="Generic placeholder image"/>
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src={ContactImg5} alt="Generic placeholder image"/>
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
