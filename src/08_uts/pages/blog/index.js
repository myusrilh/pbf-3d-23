import BlogImg1 from '../../assets/img/tm-img-1010x336-1.jpg';
import BlogImg2 from '../../assets/img/tm-img-310x180-1.jpg';
import BlogImg3 from '../../assets/img/tm-img-310x180-2.jpg';
import BlogImg4 from '../../assets/img/tm-img-310x180-3.jpg';
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                            <div class="tm-blog-post">
                                ...
                                <img src={BlogImg1} alt="Image" class="img-fluid tm-img-post"/>
                            ...
                            <div class="row tm-margin-t-big">
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <div class="tm-content-box">
                                        <img src={BlogImg2} alt="Image" class="tm-margin-b-30 img-fluid"/>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <div class="tm-content-box">
                                        <img src={BlogImg3} alt="Image" class="tm-margin-b-30 img-fluid"/>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    ...
                                    <div class="tm-content-box">
                                        <img src={BlogImg4} alt="Image" class="tm-margin-b-30 img-fluid"/>
